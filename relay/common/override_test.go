...
// TestRemoveDisabledFieldsContextManagement covers the three branches
// for the context_management field added alongside inference_geo / speed:
// strip-by-default, explicit allow, and channel pass-through.
func TestRemoveDisabledFieldsContextManagement(t *testing.T) {
	...
	t.Run("preserves context_management when channel pass-through enabled", func(t *testing.T) {
		...
		// pass-through mode: input should be returned untouched
		assertJSONEqual(t, input, string(out))
	})
}
