...
.PHONY: all build-web build-web-classic build-frontend build-frontend-classic build-all-web build-all-frontends start-api start-backend dev dev-api dev-api-rebuild dev-web dev-web-classic reset-setup
...
# Backward-compatible aliases used by TraceNex deployment docs/scripts.
...
build-all-frontends: build-all-web
