...
func printHelp() {
	fmt.Println("TraceNex " + Version + " - The next-generation LLM gateway and AI asset management system.")
	fmt.Println("Based on NewAPI by QuantumNous - https://github.com/QuantumNous/new-api")
	fmt.Println("Usage: tracenex [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
